...
VALUES (1, 'Smith', 'John', 'Минск', 12345, '5551234', 0, '2012-09-21 09:30:00'),
       (2, 'Johnson', 'Alice', 'Гродно', 23456, '5555678', 1, '2012-09-21 10:00:00'),
       (3, 'Williams', 'David', 'Брест', 34567, '5559012', 0, '2012-09-21 11:30:00'),
       (4, 'Jones', 'Sarah', 'Могилев', 45678, '5553456', 2, '2012-09-21 12:00:00'),
...
from cd.bookings bks
         join cd.members mems using (memid)
